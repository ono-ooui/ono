      ...
      (loop $loop
        ...
        (block $c_check
          (loop $c_loop
            ...
            (i32.and
              (i32.eq (call $config_cells_x (local.get $i_c)) (i32.div_u (i32.sub (i32.sub (i32.mul (global.get $w) (global.get $h)) (local.get $n)) (i32.const 1)) (global.get $w)))
              (i32.eq (call $config_cells_y (local.get $i_c)) (i32.rem_u (i32.sub (i32.sub (i32.mul (global.get $w) (global.get $h)) (local.get $n)) (i32.const 1)) (global.get $w)))
            )
